...
UPDATE songs SET file_url = 'public/songs/cover1.jpg' WHERE folder_name = 'Angry_(mood)';
UPDATE songs SET file_url = 'public/songs/cover2.jpg' WHERE folder_name = 'Arjit_Singh';
UPDATE songs SET file_url = 'public/songs/cover3.jpg' WHERE folder_name = 'Bright_(mood)';
UPDATE songs SET file_url = 'public/songs/cover4.jpg' WHERE folder_name = 'Chill_(mood)';
UPDATE songs SET file_url = 'public/songs/cover5.jpg' WHERE folder_name = 'cs';
UPDATE songs SET file_url = 'public/songs/cover6.jpg' WHERE folder_name = 'Dark_(mood)';
UPDATE songs SET file_url = 'public/songs/cover7.jpg' WHERE folder_name = 'Diljit';
UPDATE songs SET file_url = 'public/songs/cover8.jpg' WHERE folder_name = 'Funky_(mood)';
UPDATE songs SET file_url = 'public/songs/cover9.jpg' WHERE folder_name = 'Love_(mood)';
UPDATE songs SET file_url = 'public/songs/cover10.jpg' WHERE folder_name = 'ncs';
UPDATE songs SET file_url = 'public/songs/cover11.jpg' WHERE folder_name = 'Uplifting_(mood)';
UPDATE songs SET file_url = 'public/songs/cover11.jpg' WHERE folder_name = 'Uplifting_(mood)';
UPDATE songs SET file_url = 'public/songs/cover11.jpg' WHERE folder_name = 'Uplifting_(mood)';
UPDATE songs SET file_url = 'public/songs/cover11.jpg' WHERE folder_name = 'Uplifting_(mood)';
UPDATE songs SET file_url = 'public/songs/cover11.jpg' WHERE folder_name = 'Uplifting_(mood)';
UPDATE songs SET file_url = 'public/songs/cover11.jpg' WHERE folder_name = '';